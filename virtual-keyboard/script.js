...
const Keyboard = {
    ...
    init() {
        ...
        window.addEventListener("keydown", (event) => {
            if (document.querySelector(`#k_${event.keyCode}`))
            {
                ...
                document.querySelector(`#k_${event.keyCode}`).style.background = "red";
        ...
        keyLayout.forEach(key => {
            ...
            switch (key) {
                ...
                case "language":
                    ...
                    keyElement.innerHTML = createIconHTML("language") + this.properties.lang;
                ...
                case "shift":
                    ...
                    keyElement.addEventListener("click", () => {
                        this._toggleShift();
                        if (keyElement.style.background === "red")
                        {
                ...
                case "caps":
                    ...
                    window.addEventListener("keydown", (event) => {
                        if (event.keyCode === 20)
                        {
                            ...
                            else if (this.properties.capsLock && keyElement.style.background === "red") {
                                this._toggleCapsLock();
                                keyElement.style.background = "";
                                keyElement.classList.toggle("keyboard__key--active", this.properties.capsLock);
                            }
    ...
    _toggleLanguage() {
        ...
        Keyboard.elements.keys[52].innerHTML = Keyboard.elements.keys[52].innerHTML.substr(0,38) + this.properties.lang;
